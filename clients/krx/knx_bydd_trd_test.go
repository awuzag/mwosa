...
func TestKONEXStockBuildsKRXRequestAndParsesOutBlock(t *testing.T) {
	assertKRXAPICall(
		t,
		"/sto/knx_bydd_trd",
		...
		"BAS_DD",
		func(ctx context.Context, client *Client) (any, error) { return client.KONEXStock(ctx, "20250131") },
	)
}
