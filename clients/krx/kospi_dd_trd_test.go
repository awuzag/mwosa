...
func TestKOSPIIndexBuildsKRXRequestAndParsesOutBlock(t *testing.T) {
	assertKRXAPICall(
		t,
		"/idx/kospi_dd_trd",
		...
		"BAS_DD",
		func(ctx context.Context, client *Client) (any, error) { return client.KOSPIIndex(ctx, "20250131") },
	)
}
