...
func TestKOSDAQIndexBuildsKRXRequestAndParsesOutBlock(t *testing.T) {
	assertKRXAPICall(
		t,
		"/idx/kosdaq_dd_trd",
		...
		"BAS_DD",
		func(ctx context.Context, client *Client) (any, error) { return client.KOSDAQIndex(ctx, "20250131") },
	)
}
