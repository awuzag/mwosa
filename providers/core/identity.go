...
const (
	...
	OperationOpenDARTHyslrSttus    OperationID = "hyslrSttus"
	OperationOpenDARTHyslrChg      OperationID = "hyslrChgSttus"
	OperationOpenDARTEmpSttus      OperationID = "empSttus"
	OperationOpenDARTAuditOpinion  OperationID = "accnutAdtorNmNdAdtOpinion"
	OperationOpenDARTDfOcr         OperationID = "dfOcr"
	OperationOpenDARTPiicDecsn     OperationID = "piicDecsn"
	OperationOpenDARTFricDecsn     OperationID = "fricDecsn"
	OperationOpenDARTPifricDecsn   OperationID = "pifricDecsn"
	OperationOpenDARTCrDecsn       OperationID = "crDecsn"
	OperationOpenDARTBnkMngtPcbg   OperationID = "bnkMngtPcbg"
	OperationOpenDARTLwstLg        OperationID = "lwstLg"
	OperationOpenDARTBsnInhDecsn   OperationID = "bsnInhDecsn"
	OperationOpenDARTBsnTrfDecsn   OperationID = "bsnTrfDecsn"
	OperationOpenDARTTgastInhDecsn OperationID = "tgastInhDecsn"
	OperationOpenDARTTgastTrfDecsn OperationID = "tgastTrfDecsn"
	OperationOpenDARTCvbdIsDecsn   OperationID = "cvbdIsDecsn"
	OperationOpenDARTBdwtIsDecsn   OperationID = "bdwtIsDecsn"
	OperationOpenDARTExbdIsDecsn   OperationID = "exbdIsDecsn"
	OperationOpenDARTCmpMgDecsn    OperationID = "cmpMgDecsn"
	OperationOpenDARTCmpDvDecsn    OperationID = "cmpDvDecsn"
