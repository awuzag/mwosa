...
func NewService(reader DailyBarRepository) (Service, error) {
	...
	return newService(reader, nil, registry)
}
...
func NewServiceWithRepository(reader DailyBarRepository, strategies StrategyRepository) (Service, error) {
	...
	return newService(reader, strategies, registry)
}
...
func newService(reader DailyBarRepository, strategies StrategyRepository, registry core.IndicatorRegistry) (Service, error) {
	if reader == nil {
		return Service{}, oops.In("backtest_service").New("daily bar reader is nil")
	}
	return Service{reader: reader, strategies: strategies, registry: registry}, nil
}
