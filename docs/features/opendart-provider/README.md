...
```bash
mwosa provider doctor opendart -o json
mwosa inspect provider opendart -o json

mwosa sync opendart corp-codes -o json
mwosa get company 005930 --provider opendart -o json
...
mwosa get opendart raw fnlttSinglAcnt --corp-code 00126380 --business-year 2025 --report-code 11011 -o json
```
